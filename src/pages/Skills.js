...
export default function Skills () {
  ...
  function bgChanger() {
    if (this.scrollY > this.innerHeight * 1.5 && this.scrollY < this.innerHeight * 2.5) {
      setFocused(true)
      document.getElementsByClassName("skillspage")[0].style.backgroundColor="#6E8898";
    } else {
      setFocused(false)
      document.getElementsByClassName("skillspage")[0].style.backgroundColor="#1b2735";
    }
  }
